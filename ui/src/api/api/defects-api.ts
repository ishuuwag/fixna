...
import { CreateDefectResponse, Defect } from "../models";
import { ErrorResponse } from "../models";
/**
 * DefectsApi - axios parameter creator
 * @export
 */
export const DefectsApiAxiosParamCreator = function (
    ...
    createDefect: async (
      ...
      if (defect !== undefined) {
        localVarFormParams.append(
          "defect",
          new Blob([JSON.stringify(defect)], { type: "application/json" })
        );
      }
  ...
  return {
    ...
    async createDefect(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateDefectResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createDefect(
        defect,
        image,
        options
      );
 ...
 * @export
 */
export const DefectsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createDefect(
      ...
      return localVarFp
        .createDefect(defect, image, options)
...
export class DefectsApi extends BaseAPI {
  ...
  public createDefect(
    ...
    return DefectsApiFp(this.configuration)
      .createDefect(defect, image, options)
